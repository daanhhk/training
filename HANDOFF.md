...
- **DONKERE SKIN IS LIVE.** 4 tabs. **Schema-tab compleet**: plan-kaart (1a), WeekLoad (3b), dag-detail skin (3a), web-RPE + skip-dispositie (3c). Vorm: ReadinessCard (1b) + ochtend-check-in (2). Volgende = Vorm-body (Fase 3-design: LevelCard/niveau-grafiek/metrics/conditie-balans) of Trainingen (Fase 4).
